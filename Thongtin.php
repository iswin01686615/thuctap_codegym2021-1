...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="10">
             <?php
              ...
              <tr>
                <td> Birthday: </td>
                <td> <?php echo $se['Birthday'];?></td>
              </tr>
              <tr>
                <td align="center"><input class="btn btn-primary" onclick="window.location.href='doimatkhau.php'" value="Change Password"></td>
          ...
          <?php
          if(empty($_SESSION['user'])) header('location:account.php');
	      else{
		    foreach($se_all as $se)
		    {
          ?>
