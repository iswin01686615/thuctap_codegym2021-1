...
<body>
    ...
    <table border="0" cellspacing="0" cellpadding="10">
            <tr>
                ...
                <td align="center"> <?php echo $se['Email'];?></td>
			</tr>
			<tr>
				<td align="center"> Firtname  :  </td>
                <td align="center"> <?php echo $se['Firtname'];?></td>
                
             </tr>

              <tr>
                <td align="center"> Lastname  :  </td>
                <td align="center"> <?php echo $se['Lastname'];?></td>
			  </tr>
			  <tr>
                <td align="center"> Birthday  :  </td>
                <td align="center"> <?php echo $se['Birthday'];?></td>
              </tr>
			  <tr>
                <td align="center"><input class="btn btn-primary" onclick="window.location.href='doimatkhau.php'" type="button" value="Change Password"></td>
                <td align="center"><input class="btn btn-primary" onclick="window.location.href='updateacc.php'" type="button" value="Update Account"></td>
              </tr>
			  <tr>
					<td colspan="2" align="center"><input class="btn btn-primary" onclick="window.location.href='Logout.php'" type="button" value="Logout"></td>
			  </tr>
			  <?php
