...
<body>
					...
					<div class="accordion">
						<div class="accordion-item">
							<div style="position: relative" class="item">
								<input type="search" placeholder="Search..." style="border-left:none;border-right: none;border-top: none;width: 60%; height: 30px; font-size: 25px;margin-top: 20px;border-bottom: 1px solid #A69F9F;">
								<i id="search_" class="fa fa-search"></i>
						    </div>
					  	</div>
					</div>
		</div>
	...
	<div class="sign_up">
		<h1 style="color:#99080A; text-align: center">SIGN UP</h1><br><br><br>
		<table cellpadding="10px" cellspacing="30px">
			<tr>
				<td colspan="2" align="left">Title*</td>
				<td align="right">Mandatory fields*</td>
			</tr>
			<tr>
				<td><input type="radio" name="gt" checked>Mr</td>
