...
<body>
	...
	<div class="account">
		...
		<table cellpadding="10px" cellspacing="30px" align="center" style="width:60%">
			<tr>
				<td><h2>I HAVE AN ACCOUNT</h2></td>
				<td><h2>I DON'T HAVE AN ACCOUNT</h2></td>
			</tr>
			<tr>
				<td style="font-size: 13px; color: #858585" align="right">*Required Fields</td>
				<td></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="text-decoration: underline">Forgot Your Password?</td>
				<td></td>
			</tr>
			<tr>
