...
<body>
	...
	<div id="banner">
		<img style="width: 100%" src="./img/find_banner.png" alt="">
	</div>
	<h1 id="h1" style="margin-top: 90px;" class="h1">OUR SUGGESTIONS</h1>
	<div style="text-align: center;width: 60%;margin: 0px auto; margin-bottom: 80px;">
		<p style="color: #434141;font-size: 20px;">OMEGA’s iconic <font style="font-weight: bold;">Swiss watches</font> are renowned across the world for their superior precision and beauty. Explore the diverse collections and choose a timepiece that suits your lifestyle. With exquisite designs for both men and women, you’re sure to find the perfect model.</p>
	</div>
	
	<div class="column-layout__container_find">
		<div class="column-item_find">
			<a href="#"><img src="./img/find1.png" alt=""></a>
		</div>
		<div class="column-item_find">
			<a href="#"><img src="./img/find2.png" alt=""></a>
		</div>
	</div>
	<div style="text-align: center;width: 40%;margin: 100px auto;">
		<p style="color:#8C0709; font-weight: bold;font-size: 30px;font-family: 'Satisfy', cursive;">Proudly made in Switzerland, OMEGA’s watchmaking is a symbol of excellence. In fact, every material, movement and detail is crafted to meet your discerning standards.</p>
	</div>
    ...
    <div id="tabs">
		<ul>
			<li><a href="#tabs-1">BY STYLE</a></li>
			<li><a href="#tabs-2">BY MATERIAL</a></li>
			<li><a href="#tabs-3">BY FEATURE</a></li>
		</ul>
		<div id="tabs-1">
			<div class="column-layout__container6">
				<div class="column-item6">
					<a href="#"><img src="./img/find3.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find4.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find5.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find6.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find7.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find8.png" alt=""></a><br>
				</div>
			</div>
		</div>
		<div id="tabs-2">
			<div class="column-layout__container6">
				<div class="column-item6">
					<a href="#"><img src="./img/find9.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find10.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find11.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find12.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find13.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find14.png" alt=""></a><br>
				</div>
			</div>
		</div>
		<div id="tabs-3">
			<div class="column-layout__container6">
				<div class="column-item6">
					<a href="#"><img src="./img/find15.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find16.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find17.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find18.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find19.png" alt=""></a><br>
				</div>
				<div class="column-item6">
					<a href="#"><img src="./img/find8.png" alt=""></a><br>
				</div>
