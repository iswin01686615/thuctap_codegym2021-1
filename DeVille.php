...
<body>
	...
	<div class="nav_top">
		...
		<div class="nav_t_r" style="text-align: right; padding-right: 20px">
			...
			<input type="checkbox" hidden name="" class="nav__input1" id="nav-search">
	...
	<div id="banner">
		<img style="width: 100%" src="./img/deville_banner.png" alt="">
	</div>
	<h1 id="h1" style="margin-top: 90px;" class="h1">LADYMATIC</h1>
	<div class="column-layout__container1">
		<div class="column-item1">
			<a href="#"><img src="./img/deville1.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER 34 MM</p>
				49 models</a>
		</div>
	</div>
	<div style="text-align: center;">
	<button type="button" class="btn btn-outline-light btn-danger">
								SEE ALL THE LADYMATIC
			</button>
	</div>
	
	<h1 class="h1">HOUR VISION</h1>
	<div class="column-layout__container3">
		<div class="column-item3">
			<a href="#"><img src="./img/deville2.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL MASTER CHRONOMETER ANNUAL CALENDAR 41 MM </p>
				9 models</a>
		</div>
		<div class="column-item3">
			<a href="#"><img src="./img/deville3.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL MASTER CHRONOMETER 41 MM </p>

11 models</a>
		</div>
		<div class="column-item3">
			<a href="#"><img src="./img/deville4.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER CHRONOGRAPH 42 MM </p>
...
8 models</a>
	...
	<div style="text-align: center;">
	<button type="button" class="btn btn-outline-light btn-danger">
								SEE ALL THE HOUR VISION
			</button>
	</div>
	
	<h1 class="h1">TRÉSOR</h1>
	<div class="column-layout__container4">
		<div class="column-item4">
			<a href="#"><img src="./img/deville5.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL MASTER CHRONOMETER 40 MM </p>
			7 models</a>
		</div>
		<div class="column-item4">
			<a href="#"><img src="./img/deville6.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">MASTER CO‑AXIAL CHRONOMETER 40 MM </p>

11 models</a>
		</div>
		<div class="column-item4">
			<a href="#"><img src="./img/deville7.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">QUARTZ 39 MM </p>

7 models</a>
		</div>
		<div class="column-item4">
			<a href="#"><img src="./img/deville8.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">QUARTZ 36 MM </p>
...
18 models</a>
	...
	<h1 class="h1">PRESTIGE</h1>
	<div class="column-layout__container">
		<div class="column-item">
			<a href="#"><img src="./img/deville9.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER POWER RESERVE 39.5 MM </p>
				24 models</a>
		</div>
		<div class="column-item">
			<a href="#"><img src="./img/deville10.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER 39.5 MM </p>

68 models</a>
		</div>
		<div class="column-item">
			<a href="#"><img src="./img/deville11.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER 36.8 MM </p>

28 models</a>
		</div>
		<div class="column-item">
			<a href="#"><img src="./img/deville12.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER 32.7 MM </p>

68 models</a>
		</div>
		<div class="column-item">
			<a href="#"><img src="./img/deville13.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">QUARTZ 32.7 MM</p>
...
10 models</a>
	...
	<div class="column-layout__container2">
		<div class="column-item2">
			<a href="#"><img src="./img/deville14.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">QUARTZ 27.4 MM </p>
				53 models</a>
		</div>
		<div class="column-item2">
			<a href="#"><img src="./img/deville15.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">QUARTZ 24.4 MM </p>
...
20 models</a>
	...
	<div style="text-align: center;">
	<button type="button" class="btn btn-outline-light btn-danger">
								SEE ALL THE PRESTIGE
			</button>
	</div>
	
	
	<h1 class="h1">TOURBILLON</h1>
	<div class="column-layout__container4">
		<div class="column-item4">
			<a href="#"><img src="./img/deville16.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL MASTER CHRONOMETER 43 MM </p>
				1 models</a>
		</div>
		<div class="column-item4">
			<a href="#"><img src="./img/deville17.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER NUMBERED EDITION 44 MM </p>

1 models</a>
		</div>
		<div class="column-item4">
			<a href="#"><img src="./img/deville18.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER NUMBERED EDITION 38.7 MM</p>

1 models</a>
		</div>
		<div class="column-item4">
			<a href="#"><img src="./img/deville19.png" alt=""></a><br>
			<a href="#"><p style="font-weight: bold;">CO‑AXIAL CHRONOMETER LIMITED EDITION 38.7 MM </p>
